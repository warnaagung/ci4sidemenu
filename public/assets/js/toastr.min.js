...
function sendfrm(
    ...
    $.ajax({
        ...
        success: function (data) {
            $.LoadingOverlay("hide");
            for (var key of pfr.keys()) {
                pfr.delete(key);
            }
            let showalert = data.showalert ?? true;
            switch (data.code) {
                case undefined:
                    if (showalert)
                        toastr.success(data.message ?? psukses, data.alert, {
                            closeButton: !0,
                            showDuration: 250,
                            hideDuration: 500,
                            progressBar: true,
                    ...
                    if (pfunc != null) {
                        if (pParam3 != null) {
                            ...
                            pfunc(data, pParam1, pParam2, pParam3);
                        } else if (pParam2 != null) {
                            console.log("masuk if 2");
                            pfunc(data, pParam1, pParam2);
                ...
                case -1:
                    if (showalert)
                        toastr.error(data.message ?? perror, perror, {
                            closeButton: !0,
                        });
                    if (pfail != null) pfail(data);
                    break;
                default:
                    if (showalert)
                        toastr.success(data.message ?? psukses, data.alert, {
                    ...
                    if (pfunc != null) {
                        if (pParam3 != null) {
                            console.log("masuk f 1");
                            pfunc(data, pParam1, pParam2, pParam3);
                        } else if (pParam2 != null) {
                            console.log("masuk f 2");
                            pfunc(data, pParam1, pParam2);
                        } else if (pParam1 != null) {
                            console.log("masuk f 3");
                            pfunc(data, pParam1);
                        } else {
                            console.log("masuk f 4");
                            pfunc(data);
                        }
                    }
            }
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            ...
            console.log(">> keluar fail");
            toastr.error(perror, "Gagal", {
                closeButton: !0,
            });
            for (var key of pfr.keys()) {
            ...
            if (pfail != null) pfail(textStatus);
        },
    });
}
